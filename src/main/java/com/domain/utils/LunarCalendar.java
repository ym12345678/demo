...
public class LunarCalendar {
	...
	/*public static void main(String[] ss) {
		try {
			...
			//today.setTime(chineseDateFormat.parse("2019年1月11日"));
			LunarCalendar lunar = new LunarCalendar(today);
			System.out.println("北京时间：" + chineseDateFormat.format(today.getTime()) + "　农历" + lunar);
			System.out.println("北京时间：" + chineseDateFormat.format(today.getTime()) + "　农历" + DateUtil.formatDate(lunar.getDate(), "yyyy-MM-dd HH:mm:ss"));
		} catch (Exception e) {
			e.printStackTrace();
		}
	}*/
